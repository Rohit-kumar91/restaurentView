...
//  ResturentViewApp
//
//  Created by Rohit Prajapati on 14/01/19.
...
struct RestaurentListViewModel {
    let name: String
    let imageUrl: URL
    let distance : Double
    let id: String
    ...
    var formattedDistance : String? {
        return RestaurentListViewModel.numberFormatter.string(from: distance as NSNumber)
    }
    
}


extension RestaurentListViewModel {
